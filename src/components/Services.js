...
function Services() {
    const icons = [
        ...
        {name:httpimg, scale:1.0, title: 'Rest API', description:'This is where logic comes into play. Building backend logic on a server for your project is key to integrating your user interface with your business logic.' },
        {name:appscript, scale:0.6, title: 'Sheet Automation' , description:'Google Sheets automation is the simplest way to integrate front-end and back-end services, which can also be shared with other partners'},
    ]
